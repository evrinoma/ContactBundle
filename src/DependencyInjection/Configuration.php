...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->scalarNode('command')->defaultNull()->info('This option is used to command contact decoration')->end()
            ->scalarNode('query')->defaultNull()->info('This option is used to query contact decoration')->end()
            ->end()->end()
